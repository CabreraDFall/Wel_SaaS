...
const PlusIcon = ({ width = 16, height = 16, color = 'white', onClick, className }) => {
    return (
        <div
            onClick={onClick}
            className={className}
